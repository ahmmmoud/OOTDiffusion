...
parser.add_argument('--model_path', type=str, default="examples/model/test1.jpg", required=False)
parser.add_argument('--cloth_path', type=str, default="examples/garment/051412_1.jpg", required=False)
...
parser.add_argument('--step', type=int, default=5, required=False)
...
def run(model_path, cloth_path):
    ...
    masked_vton_img.save('./captured_images/mask.jpg')
    ...
    image_idx = 0
    for image in images:
        image.save('./captured_images/output.png')
        return True
    return False
